    ...
    return (
        <>
            ...
            <motion.section className="flex flex-col items-center">
                ...
                >
                    <p>Creative. Innovative. Professional.</p>
                    <button className="btn glass py-1 px-3 text-xs">
                        Available for Hire
                    </button>
                </motion.div>
                <motion.h1 className="text-center text-4xl/13 md:text-6xl/19 mt-2 md:mt-4 font-semibold tracking-tight max-w-3xl"
                ...
                <motion.p className="text-center text-gray-100 text-base/7 max-w-md mt-4 md:mt-6"
                    initial={{ y: 50, opacity: 0 }}
                    whileInView={{ y: 0, opacity: 1 }}
                    viewport={{ once: true }}
                    transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
